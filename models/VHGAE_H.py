...
class VHGAE_model(nn.Module):
    def __init__(self, 
        ...
        super().__init__()
        self.hgconv1 = HGNNConv(in_channels, hid_channels1, use_bn=use_bn, drop_rate=drop_rate)
        self.hgconv2 = HGNNConv(hid_channels1, hid_channels2, use_bn=use_bn, drop_rate=drop_rate)
    ...
    def decode(self, z):
        ...
        A_hat = torch.sigmoid(torch.matmul(z_norm, z_norm.transpose(0,1)))
        return A_hat


    def forward(self, features, A):
        z = self.encode(features, A)
